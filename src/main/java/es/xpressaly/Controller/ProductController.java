...
public class ProductController {
    ...
    public String getProducts(
        ...
        try {
            ...
            List<ProductWebDTO> products = productPage.getContent();
            if (minRating > 0) {
                products = products.stream()
                    .filter(product -> {
                        // Get the product's average rating
                        double productRating = product.rating();
                        // Only include products with rating >= minRating
                        return productRating >= minRating;
                    })
                    .collect(Collectors.toList());
            }
            
            // Add the products and metadata to the model
            ...
            // Add attributes necessary for the header (isAdmin and cartItemCount)
            ...
            e.printStackTrace();
            model.addAttribute("error", "Error loading the products: " + e.getMessage());
            return "error";
        }
    }
    ...
    public String addReview(@RequestParam Long productId,
        ...
        try {
            ...
            // Create ReviewDTO instead of Review
    ...
    public String deleteProduct(@RequestParam Long productId,                                 
        ...
        try {
            ...
            // If it is an AJAX request, return a simple JSON
            if (ajax != null && ajax) {
    ...
    public String productManagement(Model model) {
        ...
        // The products will be loaded dynamically through the API
    ...
    public ResponseEntity<byte[]> downloadReturnPolicy(@PathVariable Long id) throws IOException {
        ...
        if (productOpt.isPresent() && productOpt.get().getReturnPolicyData() != null) {
            ...
            // Load the default PDF from resources
