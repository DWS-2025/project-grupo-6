...
public class OrderController {
    ...
    @ResponseBody
    public ResponseEntity<OrderUpdateResponse> updateAmount(@RequestParam int amount, @RequestParam Long productId) {
        ...
        OrderUpdateResponse response = new OrderUpdateResponse(true, currentOrder.getTotal(), currentOrder.getProducts());
