...
public class ProductController {
    ...
    // API endpoint para cargar más productos
    @GetMapping("/api/products")
    @ResponseBody
    public List<Product> getMoreProducts(@RequestParam(defaultValue = "1") int page, @RequestParam(defaultValue = "") String search) {
        int pageSize = 10; // 2 filas de 5 productos cada una
        int skip = page * pageSize + 15; // Skip the initial 15 products plus previous pages
